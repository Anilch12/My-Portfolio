      ...
      <div id="about">
        <section  className="container py-5 fade-bright">
          ...
          <p>
            ...
            user- friendly web applications. Skilled in React.js, Next.js, JavaScript and Bootstrap. Good at working
        ...
        <section className="container py-5 fade-bright">
          ...
          <ul className="list-group border-0 black list-unstyled">
            <li className="black border-0 mb-2">
              ...
              <p className="ms-3 mt-2"><strong>Duration:</strong> 2 Years | Role: Front-End Developer</p>
              <div className="ms-3">
            ...
            <li className="black border-0 mb-2">
              ...
              <p className="ms-3 mt-2"><strong>Duration:</strong> 5 Months | Role: Front-End Developer</p>
              <div className="ms-3">
            ...
            <li className="black border-0 mb-2">
              ...
              <p className="ms-3 mt-2"><strong>Duration:</strong> 5 Months | Role: Support Role</p>
              <div className="ms-3">
